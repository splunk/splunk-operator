...
def main() -> int:
    ...
    compatibility = {
        ...
        "graviton_enabled": manifest["qualification"].get("graviton_enabled", False),
        "graviton_enterprise_image": manifest["qualification"].get("graviton_enterprise_image", ""),
    ...
    (output_dir / "qualification-report.md").write_text(
        "\n".join(
            [
                ...
                f"- graviton_enabled: {manifest['qualification'].get('graviton_enabled', False)}",
                f"- graviton_enterprise_image: {manifest['qualification'].get('graviton_enterprise_image') or 'not-configured'}",
