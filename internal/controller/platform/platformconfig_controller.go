...
// +kubebuilder:rbac:groups=platform.splunk.com,resources=platformconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=platform.splunk.com,resources=platformconfigs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=platform.splunk.com,resources=platformconfigs/finalizers,verbs=update
...
func (r *PlatformConfigReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&platformv4.PlatformConfig{}).
		Named("platform-platformconfig").
		Complete(r)
}
