...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PushBusSpec) DeepCopyInto(out *PushBusSpec) {
	*out = *in
	out.SQS = in.SQS
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PushBusSpec.
func (in *PushBusSpec) DeepCopy() *PushBusSpec {
	if in == nil {
		return nil
	}
	out := new(PushBusSpec)
