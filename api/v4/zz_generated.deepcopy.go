...
func (in *IndexerClusterSpec) DeepCopyInto(out *IndexerClusterSpec) {
	*out = *in
	in.CommonSplunkSpec.DeepCopyInto(&out.CommonSplunkSpec)
	out.BusRef = in.BusRef
	out.LargeMessageStoreRef = in.LargeMessageStoreRef
}
...
func (in *IndexerClusterStatus) DeepCopyInto(out *IndexerClusterStatus) {
	*out = *in
	...
	if in.LargeMessageStore != nil {
		in, out := &in.LargeMessageStore, &out.LargeMessageStore
		*out = new(LargeMessageStoreSpec)
		**out = **in
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LargeMessageStoreList) DeepCopyInto(out *LargeMessageStoreList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]LargeMessageStore, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LargeMessageStoreList.
func (in *LargeMessageStoreList) DeepCopy() *LargeMessageStoreList {
	if in == nil {
		return nil
	}
	out := new(LargeMessageStoreList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *LargeMessageStoreList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LargeMessageStoreSpec) DeepCopyInto(out *LargeMessageStoreSpec) {
	*out = *in
	out.S3 = in.S3
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LargeMessageStoreSpec.
func (in *LargeMessageStoreSpec) DeepCopy() *LargeMessageStoreSpec {
	if in == nil {
		return nil
	}
	out := new(LargeMessageStoreSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LargeMessageStoreStatus) DeepCopyInto(out *LargeMessageStoreStatus) {
	*out = *in
	if in.ResourceRevMap != nil {
		in, out := &in.ResourceRevMap, &out.ResourceRevMap
		*out = make(map[string]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LargeMessageStoreStatus.
func (in *LargeMessageStoreStatus) DeepCopy() *LargeMessageStoreStatus {
	if in == nil {
		return nil
	}
	out := new(LargeMessageStoreStatus)
	in.DeepCopyInto(out)
	return out
}
