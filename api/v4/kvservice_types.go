...
type KVServiceStatus struct {
	...
	// conditions represent the current state of the KVService resource.
...
type KVService struct {
	...
	// spec defines the desired state of KVService
	// +required
	Spec KVServiceSpec `json:"spec"`

	// status defines the observed state of KVService
	// +optional
	Status KVServiceStatus `json:"status,omitzero"`
}
