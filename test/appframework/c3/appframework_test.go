...
var _ = Describe("c3appfw test", func() {
	...
	BeforeEach(NodeTimeout(testenv.SetupTeardownTimeout), func(ctx SpecContext) {
		...
		var err error
		testcaseEnvInst, deployment, err = testenv.SetupTestCaseEnv(testenvInstance, "master", testenv.WithTimeout(4000))
	...
	Context("Single Site Indexer Cluster with Search Head Cluster (C3) and App Framework", func() {
		It("can deploy a C3 SVA with App Framework enabled, install apps then upgrade them", Label("tier:e2e-pr", "sva:c3", "cloud:aws", "variant:master", "feature:appframework"), NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Single Site Indexer Cluster with Search Head Cluster (C3) with App Framework", func() {
		It("can deploy a C3 SVA with App Framework enabled, install apps then downgrade them", Label("tier:e2e-pr", "sva:c3", "cloud:aws", "variant:master", "feature:appframework"), NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Single Site Indexer Cluster with Search Head Cluster (C3) with App Framework", func() {
		It("can deploy a C3 SVA with App Framework enabled, install apps, scale up clusters, install apps on new pods, scale down", Label("tier:e2e-full", "sva:c3", "cloud:aws", "cloud:gcp", "variant:master", "feature:appframework"), NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
			...
			*/
			...
			// Search for data from removed indexer. See ReadinessPollTimeout rationale above.
			searchPod = fmt.Sprintf(testenv.SearchHeadPod, deployment.GetName(), scaledSHReplicas-1)
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("can deploy a C3 SVA and have apps installed locally on Cluster Manager and Deployer", Label("tier:e2e-pr", "sva:c3", "cloud:aws", "variant:master", "feature:appframework"), NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("can deploy a C3 SVA with apps installed locally on Cluster Manager and Deployer, cluster-wide on Peers and Search Heads, then upgrade them", Label("tier:e2e-full", "sva:c3", "cloud:aws", "cloud:gcp", "variant:master", "feature:appframework"), NodeTimeout(testenv.MediumLongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("can deploy a C3 SVA with apps installed locally on Cluster Manager and Deployer, cluster-wide on Peers and Search Heads, then downgrade them", Label("tier:e2e-full", "sva:c3", "cloud:aws", "cloud:gcp", "variant:master", "feature:appframework"), NodeTimeout(testenv.MediumLongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("can deploy a C3 SVA and have apps installed and updated locally on Cluster Manager and Deployer for manual polling", Label("tier:e2e-full", "sva:c3", "cloud:aws", "cloud:gcp", "variant:master", "feature:appframework"), NodeTimeout(testenv.MediumLongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("can deploy a C3 SVA with apps installed locally on Cluster Manager and Deployer, cluster-wide on Peers and Search Heads, then upgrade them via a manual poll", Label("tier:e2e-full", "sva:c3", "cloud:aws", "cloud:gcp", "variant:master", "feature:appframework"), NodeTimeout(testenv.MediumLongTimeout), func(ctx SpecContext) {
	...
	Context("Single Site Indexer Cluster with Search Head Cluster (C3) and App Framework", func() {
		It("can deploy a C3 SVA with App Framework enabled and check isDeploymentInProgressFlag for CM and SHC CR's", Label("tier:e2e-pr", "sva:c3", "cloud:aws", "variant:master", "feature:appframework"), NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
