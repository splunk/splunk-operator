...
var _ = Describe("s1appfw test", func() {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("smoke, s1azure, appframeworkazures1, appframeworkazure, azure_sanity: can deploy a Standalone instance with App Framework enabled, install apps then upgrade them", func() {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("s1azure, smoke, appframeworkazures1, appframework, azure_sanity: can deploy a Standalone instance with App Framework enabled, install apps, scale up, install apps on new pod, scale down", func() {
