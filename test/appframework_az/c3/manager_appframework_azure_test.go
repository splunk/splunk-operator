...
var _ = Describe("c3appfw test", func() {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("integration, c3azure, managerappframeworkazurec3, appframeworkazure: can deploy a C3 SVA and have ES app installed on Search Head Cluster", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("c3, integration,managerappframeworkazurec3, appframeworkazure: can deploy a C3 SVA with apps installed locally on Cluster Manager and Deployer, cluster-wide on Peers and Search Heads, then downgrade them", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("integration, c3azure, managerappframeworkazurec3, appframeworkazure: can deploy a C3 SVA instance with App Framework enabled and install above 200MB of apps at once", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("integration, c3azure, managerappframeworkazurec3, appframeworkazure: can deploy a C3 SVA and have apps installed and updated locally on Cluster Manager and Deployer for manual polling", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("c3, integration,managerappframeworkazurec3, appframeworkazure: can deploy a C3 SVA with apps installed locally on Cluster Manager and Deployer, cluster-wide on Peers and Search Heads, then upgrade them via a manual poll", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("c3, integration,managerappframeworkazurec3, appframeworkazure: can deploy a C3 SVA and install a bigger volume of apps than the operator PV disk space", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
