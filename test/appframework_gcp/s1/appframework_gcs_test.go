...
var _ = Describe("s1appfw test", func() {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("smokegcp, s1gcp, s1_gcp_sanity: can deploy a Standalone instance with App Framework enabled, install apps then upgrade them", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("smokegcp, s1gcp, s1_gcp_sanity: can deploy a Standalone instance with App Framework enabled, install apps then downgrade them", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("s1gcp, smokegcp,  appframeworkgcp: can deploy a Standalone instance with App Framework enabled, install apps, scale up, install apps on new pod, scale down", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("s1gcp, integrationgcp,  appframeworkgcp: can deploy a Standalone instance with App Framework enabled, install apps, scale up, upgrade apps", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("s1gcp, integrationgcp,  appframeworkgcp: can deploy a Standalone and have ES app installed", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("integrationgcp, s1gcp,  appframeworkgcp: can deploy a Standalone instance with App Framework enabled and install around 350MB of apps at once", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("s1gcp, smokegcp,  appframeworkgcp: can deploy a standalone instance with App Framework enabled for manual poll", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("integrationgcp, s1gcp,  appframeworkgcp: can deploy Several standalone CRs in the same namespace with App Framework enabled", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
			...
			*/
			...
			// Wait for Standalone to be in READY status
			testcaseEnvInst.VerifyStandaloneReady(ctx, deployment, deployment.GetName(), standalone)
			testcaseEnvInst.VerifyStandaloneReady(ctx, deployment, standalone2Name, standalone2)
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("integrationgcp, s1gcp,  appframeworkgcp: can deploy a Standalone instance with App Framework enabled, install an app then disable it and remove it from app source", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("integrationgcp, s1gcp,  appframeworkgcp: can deploy a Standalone instance with App Framework enabled, attempt to update using incorrect GCS credentials", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("integrationgcp, s1gcp,  appframeworkgcp: can deploy a Standalone instance and install a bigger volume of apps than the operator PV disk space", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
	...
	Context("Standalone deployment (S1) with App Framework", func() {
		It("smokegcp, s1gcp, s1_gcp_sanity: can deploy a Standalone instance with App Framework enabled, install apps and check isDeploymentInProgress is set for Standaloen and MC CR's", NodeTimeout(testenv.LongTimeout), func(ctx SpecContext) {
