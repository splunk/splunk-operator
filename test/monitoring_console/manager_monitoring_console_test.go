...
var _ = Describe("Monitoring Console test", func() {
	...
	Context("Deploy Monitoring Console", func() {
		It("smoke, monitoringconsole: can deploy MC CR and can be configured standalone", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
	...
	Context("Standalone deployment (S1)", func() {
		It("managermc1, integration: can deploy a MC with standalone instance and update MC with new standalone deployment", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
				1.  Deploy Standalone
	...
	Context("Standalone deployment with Scale up", func() {
		It("managermc1, integration: can deploy a MC with standalone instance and update MC when standalone is scaled up", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
				1.  Deploy Standalone
				2.  Wait for Standalone to go to READY
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("managermc, smoke: MC can configure SHC, indexer instances after scale up and standalone in a namespace", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("managermc1, integration: MC can configure SHC, indexer instances and reconfigure to new MC", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
				1. Deploy Single Site Indexer Cluster
				2. Deploy Monitoring Console
	...
	Context("Multisite Clustered deployment (M4 - 3 Site clustered indexer, search head cluster)", func() {
		It("managermc2, integration: MC can configure SHC, indexer instances and reconfigure Cluster Manager to new Monitoring Console", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
	...
	Context("Standalone deployment (S1)", func() {
		It("managermc2, integration: can deploy a MC with standalone instance and update MC with new standalone deployment of similar names", NodeTimeout(testenv.LongTimeout), func() {
			/*
				Test Steps
