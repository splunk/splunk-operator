...
var _ = Describe("Monitoring Console test", func() {
	...
	Context("Deploy Monitoring Console", func() {
		It("smoke, cmaster, monitoringconsole: can deploy MC CR and can be configured standalone", func() {
			/*
				Test Steps
	...
	Context("Standalone deployment (S1)", func() {
		It("monitoringconsole, cmaster, integration: can deploy a MC with standalone instance and update MC with new standalone deployment", func() {
			/*
				Test Steps
				1.  Deploy Standalone
	...
	Context("Standalone deployment with Scale up", func() {
		It("monitoringconsole, cmaster, integration: can deploy a MC with standalone instance and update MC when standalone is scaled up", func() {
			/*
				Test Steps
				1.  Deploy Standalone
				2.  Wait for Standalone to go to READY
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("monitoringconsole, cmaster, smoke: MC can configure SHC, indexer instances after scale up and standalone in a namespace", func() {
			/*
				Test Steps
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("monitoringconsole, cmaster, integration: MC can configure SHC, indexer instances and reconfigure to new MC", func() {
			/*
				Test Steps
				1. Deploy Single Site Indexer Cluster
				2. Deploy Monitoring Console
	...
	Context("Multisite Clustered deployment (M4 - 3 Site clustered indexer, search head cluster)", func() {
		It("monitoring_console, cmaster,  integration: MC can configure SHC, indexer instances and reconfigure Cluster Manager to new Monitoring Console", func() {
			/*
				Test Steps
