...
var _ = Describe("Scaling test", func() {
	...
	Context("Standalone deployment (S1)", func() {
		It("scaling_test, cmaster, integration: Can Scale Up and Scale Down Standalone CR", func() {
	...
	Context("Clustered deployment (C3 - clustered indexer, search head cluster)", func() {
		It("scaling_test, cmaster, integration: SHC and IDXC can be scaled up and data is searchable", func() {
	...
	Context("Multisite Indexer Cluster (M4 - Multisite indexer Cluster, search head cluster)", func() {
		It("scaling_test,cmaster,  integration: Multisite IDXC can be scaled up and data is searchable", func() {
