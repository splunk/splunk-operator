...
func main() {
	...
	if err = (&intController.SharedAppRuntimeReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("sharedappruntime-controller"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SharedAppRuntime")
		os.Exit(1)
	}
