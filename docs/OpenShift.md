...
which help prevent any malicious actor from escalating access outside of the
...
following commands within your namespace. If you are using OpenShift 4.14 or newer 
you have to use `nonroot-v2` Security Context Constraint, instead.
