...
[serviceaccount](../operate/CustomResources.md#common-spec-parameters-for-splunk-enterprise-resources) if
...
For the Splunk Enterprise CR pods(replace `default` with the configured [serviceaccount](../operate/CustomResources.md#common-spec-parameters-for-splunk-enterprise-resources) if any):
```
