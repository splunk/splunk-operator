...
* `splunk/splunk:<version>`: The [Splunk Enterprise image](https://github.com/splunk/docker-splunk) (8.2.2 or later)
...
```
kubectl apply -f https://github.com/splunk/splunk-operator/releases/download/1.0.3/splunk-operator-install.yaml
```
