...
func (in *AppDeploymentContext) DeepCopyInto(out *AppDeploymentContext) {
	*out = *in
	...
	out.AppInfoStatus = in.AppInfoStatus
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppInfoStatus) DeepCopyInto(out *AppInfoStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppInfoStatus.
func (in *AppInfoStatus) DeepCopy() *AppInfoStatus {
	if in == nil {
		return nil
	}
	out := new(AppInfoStatus)
	in.DeepCopyInto(out)
	return out
}
