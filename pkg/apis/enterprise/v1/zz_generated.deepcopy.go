...
func (in *ApplicationFrameworkSpec) DeepCopyInto(out *ApplicationFrameworkSpec) {
=======
func (in *AppFrameworkSpec) DeepCopyInto(out *AppFrameworkSpec) {
>>>>>>> ccdfc8f... CSPL-763 -- address review comments, generate the CRD defintions, extend unit test cases:pkg/apis/enterprise/v1beta1/zz_generated.deepcopy.go
	*out = *in
	return
}

<<<<<<< HEAD:pkg/apis/enterprise/v1/zz_generated.deepcopy.go
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ApplicationFrameworkSpec.
func (in *ApplicationFrameworkSpec) DeepCopy() *ApplicationFrameworkSpec {
	if in == nil {
		return nil
	}
	out := new(ApplicationFrameworkSpec)
=======
...
<<<<<<< HEAD:pkg/apis/enterprise/v1/zz_generated.deepcopy.go
	out.ApplicationFrameworkRef = in.ApplicationFrameworkRef
=======
