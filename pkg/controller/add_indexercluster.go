...
var _ splunkreconcile.SplunkController = &IndexerClusterController{}
...
func (splctrl IndexerClusterController) GetInstance() enterprisev1.MetaObject {
...
func (splctrl IndexerClusterController) GetWatchTypes() []runtime.Object {
...
func (splctrl IndexerClusterController) Reconcile(client client.Client, cr enterprisev1.MetaObject) (reconcile.Result, error) {
	instance := cr.(*enterprisev1.IndexerCluster)
	return splunkreconcile.ApplyIndexerCluster(client, instance)
}
