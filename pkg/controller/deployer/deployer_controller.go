...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &enterprisev1.Deployer{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// Watch for changes to secondary resource StatefulSets and requeue the owner Deployer
	err = c.Watch(&source.Kind{Type: &appsv1.StatefulSet{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &enterprisev1.Deployer{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileDeployer) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &enterprisev1.Deployer{}
	...
	instance.TypeMeta.Kind = "Deployer"

	err = deploy.ReconcileDeployer(r.client, instance)
	if err != nil {
		return reconcile.Result{}, err
	}

	reqLogger.Info("Deployer reconciliation complete")
	return reconcile.Result{}, nil
}
