...
func TestSetPhaseAndConditions_AllPhases(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := SetPhaseAndConditions(nil, PhaseConditionInput{Phase: tt.phase, IsPaused: tt.isPaused, Message: tt.message, Generation: generation})
...
func TestSetPhaseAndConditions_NotPaused(t *testing.T) {
	result := SetPhaseAndConditions(nil, PhaseConditionInput{Phase: enterpriseApi.PhaseReady, IsPaused: false, Message: "", Generation: 1})
...
func TestSetPhaseAndConditions_Progressing(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			result := SetPhaseAndConditions(nil, PhaseConditionInput{Phase: tt.phase, IsPaused: false, Message: "", Generation: 1})
...
func TestSetPhaseAndConditions_NotStalled(t *testing.T) {
	result := SetPhaseAndConditions(nil, PhaseConditionInput{Phase: enterpriseApi.PhaseError, IsPaused: false, Message: "transient error", Generation: 1})
...
func TestSetPhaseAndConditions_TransitionTimePreservation(t *testing.T) {
	...
	result := SetPhaseAndConditions(existingConditions, PhaseConditionInput{Phase: enterpriseApi.PhaseReady, IsPaused: false, Message: "", Generation: generation})
	...
	result = SetPhaseAndConditions(existingConditions, PhaseConditionInput{Phase: enterpriseApi.PhaseError, IsPaused: false, Message: "Error occurred", Generation: generation})
	...
	result = SetPhaseAndConditions(existingConditions, PhaseConditionInput{Phase: enterpriseApi.PhaseReady, IsPaused: true, Message: "", Generation: generation})
	...
	result = SetPhaseAndConditions(nil, PhaseConditionInput{Phase: enterpriseApi.PhaseReady, IsPaused: false, Message: "", Generation: generation})
