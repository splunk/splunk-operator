...
func TestConfigurePeers(t *testing.T) {
	...
	wantRequests = append(wantRequests, request1, request2, request3, request4, request5, request6, request7, request8, request9, request10)
	body := []string{
...
func TestPostMonitoringconsoleAssetTable(t *testing.T) {
	var apiResponseMCAssetBuild *MCAssetBuildFull
	apiResponseMCAssetBuild = new(MCAssetBuildFull)
	apiResponseMCAssetBuild = &MCAssetBuildFull{
