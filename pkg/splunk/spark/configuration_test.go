...
func TestGetSparkDeployment(t *testing.T) {
	...
	test := func(instanceType InstanceType, replicas int, want string) {
		deployment, err := GetSparkDeployment(&cr, instanceType, replicas)
		if err != nil {
