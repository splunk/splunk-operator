...
var (
	...
	LongSearchSuccessCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "splunk_long_search_success_total",
			Help: "Total number of successful long searches per search head",
		},
		[]string{"sh_name"},
	)
	LongSearchFailureCounter = prometheus.NewCounterVec(
		prometheus.CounterOpts{
			Name: "splunk_long_search_failure_total",
			Help: "Total number of failed long searches per search head",
		},
		[]string{"sh_name"},
	)
...
func init() {
	...
	prometheus.MustRegister(LongSearchSuccessCounter)
	prometheus.MustRegister(LongSearchFailureCounter)
