...
func TestApplyLicenseMaster(t *testing.T) {
	...
	spltest.ReconcileTester(t, "TestApplyLicenseMaster", &current, revised, createCalls, updateCalls, reconcile)
