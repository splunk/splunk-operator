...
var _ = Describe("ClusterManager Controller", func() {
	...
	Context("ClusterManager Management failed", func() {
		...
		It("Get ClusterManager custom resource should failed", func() {
			...
			ApplyClusterManager = func(ctx context.Context, client client.Client, instance *enterpriseApi.ClusterManager, provisionerFactory provisioner.Factory) (reconcile.Result, error) {
